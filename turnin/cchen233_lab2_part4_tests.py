...
tests = [ {'description': 'PINABC =0x10, 0x20, 0x30 => PORTD = 0x60',
    ...
    {'description': 'PINABC =0xB0, 0x10, 0x30 => PORTD = 0xF3',
    'steps': [ {'inputs': [('PINA',0xB0)], 'iterations': 1 } ,
     {'inputs': [('PINB',0x10)], 'iterations': 1 },
     {'inputs': [('PINC',0x30)], 'iterations': 1 },
    'expected': [('PORTD',0xF3)],
    },
    ]
